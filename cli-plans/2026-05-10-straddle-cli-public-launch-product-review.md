...
- `release plan compatibility --json`, `release plan naming --json`, `release plan docs-support --json`, and `smoke plan approval --json` provide local evidence for the remaining current-CLI compatibility, naming, docs/support, and live-smoke approval decisions without choosing the public command, running smoke, publishing, signing, notarizing, or approving support docs.
