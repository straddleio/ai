...
- `release plan naming --json`, `release plan docs-support --json`, and `smoke plan approval --json` provide local evidence for the remaining naming, docs/support, and live-smoke approval decisions without choosing the public command, running smoke, publishing, signing, notarizing, or approving support docs.
