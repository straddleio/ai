...
but do not stop the import.`,
  ...
  straddle-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  straddle-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | straddle-pp-cli import <resource> --input -`,
