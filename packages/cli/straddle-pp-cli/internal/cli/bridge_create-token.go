...
func newBridgeCreateTokenCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&bodyCustomerId, "customer-id", "", "The Straddle generated unique identifier of the `customer` to create a bridge token for.")
