...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "capability_requests":
		return db.UpsertCapabilityRequests(data)
	case "onboard":
		return db.UpsertOnboard(data)
	case "simulate":
		return db.UpsertSimulate(data)
	case "bridge":
		return db.UpsertBridge(data)
	case "charges":
		return db.UpsertCharges(data)
	case "charges_cancel":
		return db.UpsertChargesCancel(data)
	case "charges_hold":
		return db.UpsertChargesHold(data)
	case "charges_release":
		return db.UpsertChargesRelease(data)
	case "charges_resubmit":
		return db.UpsertChargesResubmit(data)
	case "charges_unmask":
		return db.UpsertChargesUnmask(data)
	case "customers":
		return db.UpsertCustomers(data)
	case "customers_refresh_review":
		return db.UpsertCustomersRefreshReview(data)
	case "customers_review":
		return db.UpsertCustomersReview(data)
	case "customers_unmasked":
		return db.UpsertCustomersUnmasked(data)
	case "funding_event_payments":
		return db.UpsertFundingEventPayments(data)
	case "funding_events":
		return db.UpsertFundingEvents(data)
	case "linked_bank_accounts":
		return db.UpsertLinkedBankAccounts(data)
	case "linked_bank_accounts_cancel":
		return db.UpsertLinkedBankAccountsCancel(data)
	case "linked_bank_accounts_unmask":
		return db.UpsertLinkedBankAccountsUnmask(data)
	case "organizations":
		return db.UpsertOrganizations(data)
	case "paykeys":
		return db.UpsertPaykeys(data)
	case "paykeys_cancel":
		return db.UpsertPaykeysCancel(data)
	case "refresh_balance":
		return db.UpsertRefreshBalance(data)
	case "paykeys_refresh_review":
		return db.UpsertPaykeysRefreshReview(data)
	case "reveal":
		return db.UpsertReveal(data)
	case "paykeys_review":
		return db.UpsertPaykeysReview(data)
	case "unblock":
		return db.UpsertUnblock(data)
	case "paykeys_unmasked":
		return db.UpsertPaykeysUnmasked(data)
	case "payments":
		return db.UpsertPayments(data)
	case "payouts":
		return db.UpsertPayouts(data)
	case "payouts_cancel":
		return db.UpsertPayoutsCancel(data)
	case "payouts_hold":
		return db.UpsertPayoutsHold(data)
	case "payouts_release":
		return db.UpsertPayoutsRelease(data)
	case "payouts_resubmit":
		return db.UpsertPayoutsResubmit(data)
	case "payouts_unmask":
		return db.UpsertPayoutsUnmask(data)
	case "representatives":
		return db.UpsertRepresentatives(data)
	case "representatives_unmask":
		return db.UpsertRepresentativesUnmask(data)
	default:
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		...
		"funding-events":       "/v1/funding_events",
		"linked-bank-accounts": "/v1/linked_bank_accounts",
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "capability_requests", ParentTable: "accounts", ParentIDParam: "account_id", PathTemplate: "/v1/accounts/{account_id}/capability_requests"},
	}
}
