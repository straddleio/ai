...
func newOrganizationsListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&flagName, "name", "", "List organizations by name (partial match supported).")
	cmd.Flags().StringVar(&flagExternalId, "external-id", "", "List organizations by their external ID.")
