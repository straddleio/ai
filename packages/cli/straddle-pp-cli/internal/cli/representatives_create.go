...
func newRepresentativesCreateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&bodyAccountId, "account-id", "", "The unique identifier of the account this representative is associated with.")
	cmd.Flags().StringVar(&bodyDob, "dob", "", "Date of birth for the representative in ISO 8601 format (YYYY-MM-DD).")
	cmd.Flags().StringVar(&bodyEmail, "email", "", "The company email address of the representative.")
