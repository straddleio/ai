...
func newCustomersUpdateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&bodyAddress, "address", "", "An object containing the customer's address. This is optional, but if provided, all required fields must be present.")
