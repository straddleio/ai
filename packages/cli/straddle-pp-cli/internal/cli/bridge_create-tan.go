...
func newBridgeCreateTanCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "create-tan",
		Short:       "Create tan",
		Example:     "  straddle-pp-cli bridge create-tan --account-type example-value",
	...
	cmd.Flags().StringVar(&bodyRoutingNumber, "routing-number", "", "Bank routing number.")
	cmd.Flags().StringVar(&bodyTan, "tan", "", "Tokenized account number.")
